...
Get thumbnail images of posts along with Excerpts.
...
1) By default it shows on left side thumbnail.
	screen1.jpg when thumbnail css style is used with float: left

2) To display thumbnails onto right side.
	screen2.jpg when thumbnail css style is used with float: right
...
Go to Settings -> Get Excerpt with Thumbnail page, to change configuration for the plug-in.
